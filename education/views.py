...
def submit_topic(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            question = Question.objects.create(topic=topic, context=generated_content, question_text=question_text)
            return redirect('topic_submitted', question_id=question.id)
    else:
        form = TopicForm()
